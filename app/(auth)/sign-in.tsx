        ...
        <SafeAreaView className='bg-primary h-full '>
            <ScrollView contentContainerStyle={{ width: "100%", height: "100%" }}>
                <View className='w-full h-full justify-center items-center ease-linear delay-100'>
                    ...
                    <Text className='text-white text-xl font-bold'>Log in to Aora</Text>
                    <View className='w-full justify-center items-center gap-2 m-4'>
                            ...
                            >
                                {
                                    loading ? (
                                        ...
                                        <Text className='text-center text-white font-psemibold'>Sign In</Text>
                                    )
                                }
                            </TouchableOpacity>
                        ...
                        <Text className="text-white font-semibold text-center">
                            Don't have an account? <Text className='text-orange-500' onPress={() => {
                                router.push("/sign-up");
                            }}>Sign Up</Text>
                        </Text>
                    </View>
